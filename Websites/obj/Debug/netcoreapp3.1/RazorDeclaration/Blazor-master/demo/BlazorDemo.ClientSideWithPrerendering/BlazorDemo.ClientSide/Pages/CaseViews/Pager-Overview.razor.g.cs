#pragma checksum "C:\Users\sachkovski.ev\source\repos\Websites\Websites\Blazor-master\demo\BlazorDemo.ClientSideWithPrerendering\BlazorDemo.ClientSide\Pages\CaseViews\Pager-Overview.razor" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "98acb7249940e389fc67c77e6e75783b92f73f07"
// <auto-generated/>
...
#nullable disable
#nullable restore
#line 1 "C:\Users\sachkovski.ev\source\repos\Websites\Websites\Blazor-master\demo\BlazorDemo.ClientSideWithPrerendering\BlazorDemo.ClientSide\Pages\CaseViews\Pager-Overview.razor"
...
#nullable disable
    ...
    public partial class Pager_Overview : Microsoft.AspNetCore.Components.ComponentBase
    {
...
#nullable restore
#line 45 "C:\Users\sachkovski.ev\source\repos\Websites\Websites\Blazor-master\demo\BlazorDemo.ClientSideWithPrerendering\BlazorDemo.ClientSide\Pages\CaseViews\Pager-Overview.razor"
       
    int pageCount = 10;
    int PageCount { get => pageCount; set { pageCount = value; InvokeAsync(StateHasChanged); } }

    int activePageIndex = 1;
    int ActivePageIndex { get => activePageIndex; set { activePageIndex = value; InvokeAsync(StateHasChanged); } }

    int collapseButtonCount = 10;
    int CollapseButtonCount { get => collapseButtonCount; set { collapseButtonCount = value; InvokeAsync(StateHasChanged); } }
